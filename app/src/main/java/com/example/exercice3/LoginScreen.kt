...
class LoginScreen(onSignupClick: () -> Unit, onForgotPasswordClick: () -> Unit) : ComponentActivity() {
        ...
        setContent {
            Exercice3Theme {
                Scaffold(modifier = Modifier.fillMaxSize(),
                    ...
                    LoginScreen({ navController.navigate("signup") }) { navController.navigate("reset_password") }
                }
            }
        }
    }
